...
/**
 * The means of viewing the list Featured Pages for the Calendar Solution
 *
 ...
 */
try {
	$calendar = new CalendarSolution_FeaturedPage_List;
} catch (Exception $e) {
...
<html>
<head>
<title>Calendar Solution Admin Featured Pages</title>
