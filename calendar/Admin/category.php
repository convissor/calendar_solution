...
/**
 * The means of viewing the list Categories for the Calendar Solution
 *
 ...
 */
try {
	$calendar = new CalendarSolution_Category_List;
} catch (Exception $e) {
...
<html>
<head>
<title>Calendar Solution Admin Categories</title>
