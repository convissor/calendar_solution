...
try {
	$calendar = new CalendarSolution_FeaturedPage_Form;
} catch (Exception $e) {
...
<html>
<head>
<title>Calendar Solution Admin Featured Page Details</title>
...
try {
	if (empty($_POST['submit'])) {
		if (empty($_GET['feature_on_page_id'])) {
			$calendar->set_data_empty();
		} else {
			$calendar->set_data_from_query($_GET['feature_on_page_id'], false);
		}
